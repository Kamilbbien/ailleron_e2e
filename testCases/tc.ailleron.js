var ailleronSite = require('../pageObjects/po.ailleron.js');
var testData = require('../testData/td.ailleron.js');
const { browser } = require('protractor');

describe('Check Intership options', function () {

    var utils = new ailleronSite.Utils();
    var career = new ailleronSite.Career();   
    ...
    it('Check Carrer page - Meet Us section', async () => {
        await career.checkMeetUsSection(testData.meetUs.title, testData.meetUs.about);
    });
    ...
    it('Check Carrer page - Contact section', async () => {
        await utils.checkContactSection(testData.contact.title, testData.contact.about);
    });
});